...
for (article in nmArticles){
  ...
  #So, right now we have the article name, but it is in subfolders. But we can solve this! 
  arDir = paste("data/NonMachineRead/", article, sep ="") #Article directory
  
  #Okay, now we are ready to read in the article
  A <- ocr(arDir, engine = danish)
  ...
  #Cool, now because we have the non machinable PDFs
